...
export const giftBaskets: GiftBasket[] = [
  {
    ...
    price: 500000,
    image:
      "https://images.unsplash.com/photo-1519999482648-25049ddd37b1?w=500&auto=format&fit=crop&q=60",
    occasion: "Thăm bệnh",
    description:
      "Giỏ quà trái cây tươi ngon, giàu vitamin, thích hợp biếu tặng người ốm, người lớn tuổi.",
  ...
  },
  {
    ...
    price: 1200000,
    image:
      "https://images.unsplash.com/photo-1595123550441-d377e017de6a?w=500&auto=format&fit=crop&q=60",
    occasion: "Khai trương",
    description:
      "Thiết kế sang trọng, đẳng cấp với các loại trái cây nhập khẩu cao cấp, mang ý nghĩa may mắn.",
  ...
  },
  {
    ...
    occasion: "Tết",
    description:
      "Hộp quà Tết sang trọng, kết hợp trái cây và rượu vang/hạt dinh dưỡng.",
  ...
  },
  {
    ...
    price: 300000,
    image:
      "https://images.unsplash.com/photo-1618160702438-9b02ab6515c9?w=500&auto=format&fit=crop&q=60",
    occasion: "Tiệc nhẹ",
